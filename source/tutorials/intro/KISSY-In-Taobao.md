...
* 拥有大量的中文文档： 方便不熟悉英文的国内开发者快速入门搭建自己的应用。
...
KISSY 1.3 的模块化机制与目前的 AMD 规范比较类似，并根据淘宝自身业务特点加入了自动 combo 功能。现简单介绍如下：
...
* 基于统一的渲染方式，既模板（tmpl）和数据（data）产生html片段，innerHTML 到 DOM 节点中.
...
这套独特的Web无线解决方案力争将 HTML5 和 CSS3 的优势发挥至最佳，做到即调即用。
