...
-----------------------------------------------
    ...
    * :data:`~UIBase.Box.config.height`
    * :data:`~UIBase.Box.config.elCls`
    * :data:`~UIBase.Box.config.elStyle`
    * :data:`~UIBase.Box.config.elAttrs`
    * :data:`~UIBase.Box.config.elBefore`
    * :data:`~UIBase.Box.config.render`
    * :data:`~UIBase.Box.config.visible`
    * :data:`~UIBase.Box.config.visibleMode`
    * :data:`~UIBase.Box.config.srcNode`
...
-----------------------------------------------
    ...
    * :meth:`~UIBase.Box.prototype.show`    
    * :meth:`~UIBase.Box.prototype.hide`    
...
.. attribute:: UIBase.Box.prototype.el
...
.. method:: UIBase.Box.prototype.show()

    | **show()**

    渲染该组件并显示出来.
    
.. method:: UIBase.Box.prototype.hide()
