...
.. function:: clone
    ...
    :param boolean withDataAndEvent: 节点是否具备源节点的 :func:`dom.data` 属性以及 :mod:`事件 <event>`
    :param boolean deepWithDataAndEvent: 子孙节点是否具备源节点对应子孙节点的 :func:`dom.data` 属性以及 :mod:`事件 <event>`
...
.. raw:: html
    ...
    <iframe width="100%" height="135" src="../../../static/api/core/dom/clone.html"></iframe>