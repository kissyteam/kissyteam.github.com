(function () {
    ...
    if (h.indexOf("localhost/kissy_git/") != -1) {
        d.write('<script src="http://localhost/kissy_git/kissy/build/seed.js"' +
...
// ie write 行内脚本立即执行
        ...
        d.write('<script src="http://chengyu.taobao.ali.com/kissy_git/kissy/build/seed.js"' +
            ' charset="utf-8"><' + '/script>');
        ...
        d.write('<script src="http://fed.ued.taobao.net/kissy-team/kissy/build/seed.js"' +
            ' charset="utf-8">' + '<' + '/script>');
        d.write('<script src="http://fed.ued.taobao.net/kissy-team/kissyteam/assets/import-gallery.js"' +
            ' charset="utf-8"><' + '/script>');
    }
    else {
        d.write('<script src="http://docs.kissyui.com/kissy/build/seed.js"' +
            ' charset="utf-8">' + '<' + '/script>');
