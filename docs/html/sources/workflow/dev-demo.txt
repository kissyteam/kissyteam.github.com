...
在本地, 创建组件的目录结构, 可以参考 `这里 <https://github.com/kissyteam/kissy-gallery/tree/master/sliding-labels>`_ 或者直接下载 `压缩包 <https://github.com/kissyteam/kissy-gallery/blob/master/your-gallery.zip>`_
