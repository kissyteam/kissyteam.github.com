...
===============================================
    ...
    KISSY 中提供了 Ajax 异步请求功能, 下面仅介绍最常用的 :ref:`getScript() <loader-getScript>` 方法, 其他 ajax 模块中的方法, 如 ``get``, ``post`` 等，请参考 API 文档 [1]_ .
...
下面介绍个如何通过 :ref:`getScript() <loader-getScript>` 方法去请求 flickr 上提供的图片数据.
...
稍加解释下:
 ...
 #. 组装参数时, 使用到了 :ref:`S.param() <lang-param>` 方法, 是将对象 data 转换为 URL 中的参数字符串, 且是经过 encodeURI 编码的.
