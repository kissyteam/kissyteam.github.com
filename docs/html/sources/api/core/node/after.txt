...
:meth:`~NodeList.insertAfter` 和该方法的功能一样，只不过参数意义不同， ``insertAfter`` 表示当前节点列表被插入到参数目标节点之后，
...
.. raw:: html
    ...
    <iframe width="100%" height="135" src="../../../static/api/core/node/after.html"></iframe>                               