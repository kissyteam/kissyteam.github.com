...
.. method:: NodeList.height
    ...
    .. raw:: html
        ...
        <img  src='/1.4/source/raw/api/node/height.png' />
...
**得到各种各样的高度, 黄色高亮区域代表 iframe 体**
    ...
    .. raw:: html
        ...
        <iframe width="100%" height="135"  class="iframe-demo" src="/1.4/source/raw/api/node/height-get.html"></iframe>


    .. literalinclude:: /raw/api/node/height-get.html
       :language: html
...
**设置元素的高度**
    ...
    .. raw:: html
        ...
        <iframe width="100%" height="135"  class="iframe-demo" src="/1.4/source/raw/api/node/height-set.html"></iframe>

    .. literalinclude:: /raw/api/node/height-set.html
       :language: html
