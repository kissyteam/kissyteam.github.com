...
为了增强 KISSY 的模块架构和减轻体积，1.4.0 之后将不再提供粗粒度的`kissy.js`，因此`http://g.tbcdn.cn/kissy/k/1.4.2/kissy.js`不存在。KISSY 将只提供`seed.js`。
...
[KISSY 1.4.2 Changelog](https://github.com/kissyteam/kissy/releases/tag/v1.4.1)
